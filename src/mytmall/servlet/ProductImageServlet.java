...
public class ProductImageServlet extends BaseBackServlet {
	...
	public String delete(HttpServletRequest request, HttpServletResponse response, Page page) {
        ...
        return "@admin_productImage_list?pid="+pi.getPtid();
    }
    ...
    {
    	Product p = productDAO.get(Integer.parseInt(request.getParameter("pid")));
    	Category c = categoryDAO.get(p.getCid());
    	List<ProductImage> pisSingle = productImageDAO.list(p.getId(), ProductImageDAO.type_single);
    	List<ProductImage> pisDetail = productImageDAO.list(p.getId(), ProductImageDAO.type_detail);
